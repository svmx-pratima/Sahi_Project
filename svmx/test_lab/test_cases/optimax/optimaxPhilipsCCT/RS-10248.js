/*If Technician has subsequent WorkOrder assigned,but is not allowed 
 * to commence work on the same ahead of schedule,
 * then use the extra time as idle/travel time for next WorkOrder*/
...
//Validating if the WO has "Can Start late enabled"
...
_log("The Tech has arrived early. Will validate if he can start early");
}
_doubleClick(_div("00N1N00000KGqDv_ileinner"));
_assertFalse(_getAttribute(_checkbox("00N1N00000KGqDv") , "unchecked"));
_log("The Tech cannot start the WO ahead of time");
