/*WorkOrder picked for Optimization, should change the Status of Dispatch status from New to Assigned. 
 * The Schedule Status on the WorkOrder should move to ‘Tentative’*/
...
//Validating if the WO Disparh Status and Scheduling Status changed

var $SchedulingStatus=_getText(_div("00N1N00000KGqEq_ileinner"));
var $DispatchStatus=_getText(_div("00N1N00000KGqCQ_ileinner"));

if($SchedulingStatus=="Tentative" && $DispatchStatus=="Assigned"){
	_log("WO picked by the Optimization Engine with right Scheduling and Dispatch status" );
}
else{
	_Break();
}
