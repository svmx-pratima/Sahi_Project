//Verifying if the Dispatch Process is set for the specified Territory
...
if ($WoPrimaryTerritory==$DP_Territory){
	_log("The Dispatch Process picked has the same territory as associated to WO");
}
else{
	_fail("Dispatch process territory is not the same as WO's territory");
