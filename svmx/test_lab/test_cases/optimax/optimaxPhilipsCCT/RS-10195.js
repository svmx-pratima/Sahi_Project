//Create a new Technician  Record in ServiceMax application 
//Login to SFDC
_navigateTo($url);
...
if((parseInt($yr1[2])>parseInt($yr2[2]) || parseInt($yr1[2]) == parseInt($yr2[2])) &&(parseInt($yr1[3])>parseInt($yr2[3]) || parseInt($yr1[3]) == parseInt($yr2[3])) )
	{
		_stop();
		_log("Shift Association is not Correct");
	}
		...
		_log("Tech Association to Shift successful and New Tech record is created ");
