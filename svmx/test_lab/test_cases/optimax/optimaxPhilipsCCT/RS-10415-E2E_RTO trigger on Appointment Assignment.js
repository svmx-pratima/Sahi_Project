//As a Dispatcher, I should be able to see RTO pick up the WO and assign it to a tech based on selection of Appointment slot
...
/*_log($Val8.substring(21,25)==$Val5.getFullYear() +""+ 
	...
	var $Val12=(_getText(_div("00N1N00000KGqEq_ileinner")));//Scheduling Status
	var $Val13=(_getText(_div("CF00N1N00000KGqEH_ileinner")));//Service Team
	var $Val14=(_getText(_div("CF00N1N00000KGqCd_ileinner")));//Assigned Tech
	var $Val15=(_getText(_div("00N1N00000KGqEB_ileinner")));
	var $Val16=(_getText(_div("00N1N00000KGqDA_ileinner")));
	var $Val17=(_getText(_div("00N1N00000KGqCQ_ileinner")));
	_log($Val9+" "+$Val10+" "+$Val11+" "+$Val12+" "+$Val13+" "+$Val14+" "+$Val15+" "+$Val16+" "+$Val17);
	...
	else if ((($Val12 !=null) || ($Val13 !=null) || ($Val14 !=null)) && (($Val15 !=null) && ($Val16 !=null) && ($Val17 ==("Assigned"))))
			{
			_log("WO is assigned to Technician. Please look into WO for details");
			}
