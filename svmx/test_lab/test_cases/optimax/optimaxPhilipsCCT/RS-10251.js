/*If Technician finishes work later ,and has subsequent WorkOrder assigned , 
and if he/she is allowed to  commence work on the subsequent workorder behind of 
 *schedule and complete the service , then conitinue to work on Subsequent WorkOrder*/
...
var $ScheduledStartTime=new Date(_getText(_div("00N1N00000KGqEB_ileinner")));
_log($ScheduledStartTime);
...
else if($CurrentTime<=$ScheduledStartTime){
