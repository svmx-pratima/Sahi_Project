//User should be able to select an appointment from Appointment booking window.
...
/*_log($Val8.substring(21,25)==$Val5.getFullYear() && 
	...
	_fail("WO not assigned to Technician. Please look into the Wo for Errors or scheduling violations");
		...
		_log("Dispatcher/ServiceManager successfull in picking Appointment Slot for WO");
	}
